...
export const CIUDADES: Array<Ciudad> = [
...
export const PLANES: Array<Plan> = [
...
export const GENEROS: Array<string> = [
...
const grad = (h1: number, h2: number) =>
  `linear-gradient(160deg, oklch(0.5 0.13 ${h1}), oklch(0.22 0.04 ${h2}))`

export const CATALOGO: Array<Contenido> = [
...
export const EPISODIOS: EpisodiosMap = {
  2: {
    temporadas: [
...
export const RELACIONES: Array<Relacion> = [
...
export const FAVORITOS: Array<Favorito> = [
...
export const REPRODUCCIONES: Array<Reproduccion> = [
...
export const DEPARTAMENTOS: Array<Departamento> = [
...
export const REPORTES: Array<Reporte> = [
...
export const REFERIDOS: Array<Referido> = [
